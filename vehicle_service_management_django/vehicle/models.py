...
class Request(models.Model):
    cat=(('two wheeler with gear','two wheeler with gear'),('two wheeler without gear','two wheeler without gear'),('four wheeler','four wheeler'))
    ...
    Km_Driven = models.PositiveIntegerField(max_length=40,null=True,blank=True)
